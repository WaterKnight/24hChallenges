//===========================================================================
// 
// Journey for Water 0.5c
// 
//   Warcraft III map script
//   Generated by the Warcraft III World Editor
//   Date: Fri Apr 15 22:25:02 2016
...
globals
    ...
    destructable            gg_dest_DTlv_1712          = null
    trigger                 gg_trg_kegExplo            = null
    rect                    gg_rct_portTarg            = null
    rect                    gg_rct_way6b               = null
endglobals
...
function Unit000074_DropItems takes nothing returns nothing
    ...
    if (canDrop) then
        ...
        call RandomDistAddItem( 'blba', 100 )
...
function Unit000081_DropItems takes nothing returns nothing
    ...
    if (canDrop) then
        // Item set 0
        call RandomDistReset(  )
        call RandomDistAddItem( 'bfhr', 100 )
        set itemID = RandomDistChoose(  )
        if (trigUnit != null) then
            call UnitDropItem( trigUnit, itemID )
        else
...
function Unit000244_DropItems takes nothing returns nothing
    ...
    if (canDrop) then
        // Item set 0
        call RandomDistReset(  )
        call RandomDistAddItem( 'nflg', 100 )
        set itemID = RandomDistChoose(  )
        if (trigUnit != null) then
            call UnitDropItem( trigUnit, itemID )
        else
...
function Unit000293_DropItems takes nothing returns nothing
    ...
    if (canDrop) then
        // Item set 0
        call RandomDistReset(  )
        call RandomDistAddItem( 'tgxp', 100 )
        set itemID = RandomDistChoose(  )
        if (trigUnit != null) then
            call UnitDropItem( trigUnit, itemID )
        else
...
function Unit000299_DropItems takes nothing returns nothing
    ...
    if (canDrop) then
        // Item set 0
        call RandomDistReset(  )
        call RandomDistAddItem( 'srtl', 100 )
        set itemID = RandomDistChoose(  )
        if (trigUnit != null) then
            call UnitDropItem( trigUnit, itemID )
        else
...
function Unit000306_DropItems takes nothing returns nothing
    ...
    if (canDrop) then
        // Item set 0
        call RandomDistReset(  )
        call RandomDistAddItem( 'bzbe', 100 )
        set itemID = RandomDistChoose(  )
        if (trigUnit != null) then
            call UnitDropItem( trigUnit, itemID )
        else
...
function Unit000349_DropItems takes nothing returns nothing
    local widget  trigWidget = null
    local unit    trigUnit   = null
    local integer itemID     = 0
    local boolean canDrop    = true
    ...
    if (canDrop) then
        ...
        call RandomDistAddItem( 'ajen', 50 )
        set itemID = RandomDistChoose(  )
        if (trigUnit != null) then
            call UnitDropItem( trigUnit, itemID )
        else
...
function Unit000352_DropItems takes nothing returns nothing
    local widget  trigWidget = null
    local unit    trigUnit   = null
    local integer itemID     = 0
    local boolean canDrop    = true
...
function Unit000365_DropItems takes nothing returns nothing
    ...
    if (canDrop) then
        // Item set 0
        call RandomDistReset(  )
        call RandomDistAddItem( 'asbl', 100 )
        set itemID = RandomDistChoose(  )
        if (trigUnit != null) then
            call UnitDropItem( trigUnit, itemID )
        else
...
function Unit000369_DropItems takes nothing returns nothing
    local widget  trigWidget = null
    local unit    trigUnit   = null
    local integer itemID     = 0
    local boolean canDrop    = true
    ...
    if (canDrop) then
        // Item set 0
        call RandomDistReset(  )
        call RandomDistAddItem( 'srbd', 100 )
        set itemID = RandomDistChoose(  )
        if (trigUnit != null) then
            call UnitDropItem( trigUnit, itemID )
        else
...
function CreateAllDestructables takes nothing returns nothing
    ...
    local trigger t
    local real life
    set gg_dest_DTlv_1712 = CreateDestructable( 'DTlv', 3296.0, -13728.0, 286.000, 0.972, 0 )
endfunction
...
function CreateAllItems takes nothing returns nothing
    ...
    call CreateItem( 'ankh', 311.3, 354.3 )
    call CreateItem( 'ankh', -3356.1, 6954.3 )
    call CreateItem( 'ankh', -2997.0, 6413.3 )
    call CreateItem( 'bgst', -1915.9, -9336.1 )
    call CreateItem( 'brac', 5759.6, 5959.6 )
    call CreateItem( 'fgdg', 2071.5, 3939.8 )
    call CreateItem( 'fgfh', 7014.5, -3426.6 )
    ...
    call CreateItem( 'fgsk', 6697.7, -10041.3 )
    call CreateItem( 'gold', 313.2, 1904.7 )
    call CreateItem( 'gold', -3005.4, 8105.3 )
    call CreateItem( 'gold', 6771.2, -10144.9 )
    call CreateItem( 'gold', -2970.3, 8050.8 )
    call CreateItem( 'gold', -1487.0, -3526.7 )
    call CreateItem( 'gold', -3024.1, 8022.4 )
    call CreateItem( 'gold', 492.7, 1929.9 )
    call CreateItem( 'hval', 1647.1, -4466.8 )
    call CreateItem( 'infs', 832.1, -4601.1 )
    call CreateItem( 'lmbr', 912.3, 562.8 )
    call CreateItem( 'lmbr', 1321.7, 1521.6 )
    call CreateItem( 'lmbr', 562.0, 1918.8 )
    call CreateItem( 'lmbr', 1091.5, 583.0 )
    ...
    call CreateItem( 'mcou', -3266.9, -314.7 )
    call CreateItem( 'mnst', -84.5, -3948.1 )
    call CreateItem( 'ocor', 1812.2, -4574.0 )
    call CreateItem( 'pdiv', -4583.5, 3634.2 )
    call CreateItem( 'pghe', 1899.1, 4081.0 )
    call CreateItem( 'pman', 249.0, -1300.6 )
    call CreateItem( 'pman', -104.0, -1125.1 )
    call CreateItem( 'pomn', 404.9, 252.9 )
    call CreateItem( 'pres', -2038.0, -9429.6 )
    call CreateItem( 'rhe1', -5362.2, -7616.6 )
    call CreateItem( 'rlif', -2862.7, -1252.0 )
    call CreateItem( 'rnec', -2086.7, -11176.4 )
    call CreateItem( 'rnec', -2006.7, -11268.8 )
    call CreateItem( 'rspd', -1492.5, 4414.5 )
    call CreateItem( 'rspd', 2134.6, 4061.9 )
    call CreateItem( 'rspd', 3390.3, 6504.2 )
    call CreateItem( 'rsps', 2572.8, -866.5 )
    call CreateItem( 'sbch', 131.0, -1061.5 )
    call CreateItem( 'shea', 6951.0, -3542.5 )
    call CreateItem( 'sneg', 2084.0, -11607.1 )
    ...
    call CreateItem( 'tgxp', -4603.2, 3888.6 )
    call CreateItem( 'tgxp', -4439.7, 3432.2 )
    call CreateItem( 'tgxp', -4701.5, 3398.6 )
    call CreateItem( 'tgxp', -4315.2, 3643.7 )
    call CreateItem( 'tgxp', -4826.2, 3695.6 )
    ...
    call CreateItem( 'tkno', -2960.5, 8159.5 )
    call CreateItem( 'tkno', -2492.3, 7381.8 )
    call CreateItem( 'tpow', 1238.9, 1913.4 )
    call CreateItem( 'tpow', 1270.5, 1850.2 )
    call CreateItem( 'tpow', 6773.1, -9973.1 )
    call CreateItem( 'tpow', 6272.8, -7175.0 )
    call CreateItem( 'tpow', 6818.9, -9911.9 )
    ...
    call CreateItem( 'tpow', 6822.6, -10000.1 )
    ...
    call CreateItem( 'wlsd', 6238.9, -1395.8 )
    call CreateItem( 'wlsd', 6789.4, -1834.8 )
...
function CreateBuildingsForPlayer0 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hhou', 1056.0, -13280.0, 270.000 )
endfunction
...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hgry', -969.0, 7436.4, 56.065 )
endfunction
...
function CreateBuildingsForPlayer1 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hhou', 992.0, -12512.0, 270.000 )
endfunction
...
function CreateBuildingsForPlayer2 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hhou', 672.0, -13088.0, 270.000 )
endfunction
...
function CreateBuildingsForPlayer3 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hhou', 1824.0, -13664.0, 270.000 )
endfunction
...
function CreateBuildingsForPlayer4 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hhou', 352.0, -12704.0, 270.000 )
endfunction
...
function CreateBuildingsForPlayer5 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hhou', 1376.0, -13664.0, 270.000 )
endfunction
...
function CreateBuildingsForPlayer6 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hhou', 672.0, -12128.0, 270.000 )
endfunction
...
function CreateBuildingsForPlayer7 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hhou', 672.0, -12576.0, 270.000 )
endfunction
...
function CreateBuildingsForPlayer8 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hhou', 928.0, -13664.0, 270.000 )
endfunction
...
function CreateBuildingsForPlayer9 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hhou', 224.0, -12256.0, 270.000 )
endfunction
...
function CreateBuildingsForPlayer10 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hhou', 1440.0, -13216.0, 270.000 )
endfunction
...
function CreateBuildingsForPlayer11 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hhou', 1056.0, -12896.0, 270.000 )
endfunction
...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'ndrf', -570.7, -2250.8, 129.750 )
    set t = CreateTrigger(  )
    ...
    set u = CreateUnit( p, 'nstw', -4839.3, -4096.0, 227.300 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    ...
    set u = CreateUnit( p, 'nrzg', 2879.7, -6099.3, 169.887 )
    set u = CreateUnit( p, 'nrzg', 2238.0, -6347.5, 353.694 )
    set u = CreateUnit( p, 'nhrw', 489.8, -6084.3, 195.607 )
    set u = CreateUnit( p, 'nspp', 2472.7, -6090.6, 60.635 )
    set u = CreateUnit( p, 'nspp', 2923.1, -6417.3, 170.019 )
    set u = CreateUnit( p, 'nspp', 2491.4, -6548.5, 260.384 )
    set u = CreateUnit( p, 'nrzm', 2561.2, -6305.6, 259.516 )
    set u = CreateUnit( p, 'nrzm', 2717.0, -6712.9, 347.266 )
    set u = CreateUnit( p, 'nbzd', 855.1, 1135.1, 57.520 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    ...
    set u = CreateUnit( p, 'Orex', 1192.1, 3277.2, 101.020 )
    ...
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    call TriggerAddAction( t, function Unit000349_DropItems )
    ...
    set u = CreateUnit( p, 'ninf', 4470.5, 10843.0, 306.570 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    ...
    set u = CreateUnit( p, 'nmgd', -1542.8, 3210.7, 97.600 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    ...
    set u = CreateUnit( p, 'ncen', -1749.5, -4860.4, 106.109 )
    set u = CreateUnit( p, 'nfsh', -1407.5, -3306.2, 35.520 )
    set u = CreateUnit( p, 'nfsp', -4329.0, -3789.9, 242.892 )
    ...
    set u = CreateUnit( p, 'nrzb', -2037.6, -9174.4, 291.355 )
    set u = CreateUnit( p, 'ncim', -3072.9, -7701.7, 134.323 )
    set u = CreateUnit( p, 'nsrn', -396.3, -3810.3, 233.972 )
    set u = CreateUnit( p, 'nsrn', 118.0, -4894.2, 210.812 )
    set u = CreateUnit( p, 'nlrv', 5794.1, -5396.0, 249.500 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    call TriggerAddAction( t, function Unit000248_DropItems )
    set u = CreateUnit( p, 'nmsc', 6568.8, -6190.0, 191.552 )
    ...
    set u = CreateUnit( p, 'Nfir', 2072.7, 4198.5, 73.010 )
    call SetHeroLevel( u, 5, false )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    call TriggerAddAction( t, function Unit000369_DropItems )
    ...
    set u = CreateUnit( p, 'Uwar', -5672.9, 5418.4, 268.410 )
    call SetHeroLevel( u, 3, false )
    call SelectHeroSkill( u, 'ANdp' )
    call SelectHeroSkill( u, 'ANrc' )
    ...
    set u = CreateUnit( p, 'hphx', -1072.3, 2995.1, 134.630 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    call TriggerAddAction( t, function Unit000293_DropItems )
    set u = CreateUnit( p, 'hphx', -1963.5, 2704.4, 70.320 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    ...
    set u = CreateUnit( p, 'nvde', 480.0, 10609.2, 294.370 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    ...
    set u = CreateUnit( p, 'nhrq', 2645.8, -6459.3, 20.120 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    call TriggerAddAction( t, function Unit000081_DropItems )
    set u = CreateUnit( p, 'nhrw', 471.2, -6651.4, 203.056 )
    set u = CreateUnit( p, 'ncim', -1229.3, -8393.1, 249.397 )
    set u = CreateUnit( p, 'nfre', 5706.1, -6054.4, -40.687 )
    set u = CreateUnit( p, 'nmit', 3637.4, -10015.8, 140.948 )
    set u = CreateUnit( p, 'nspp', -2900.7, -8189.4, 134.951 )
    set u = CreateUnit( p, 'nspp', -2879.5, -7801.1, 134.951 )
    set u = CreateUnit( p, 'nspp', -2959.5, -7377.0, 134.951 )
    set u = CreateUnit( p, 'nspp', -3569.4, -7489.7, 134.951 )
    set u = CreateUnit( p, 'nspp', -3510.0, -7722.8, 205.655 )
    set u = CreateUnit( p, 'nspp', -2744.8, -8140.9, 208.620 )
    set u = CreateUnit( p, 'nhrr', -4870.6, -5523.8, 249.028 )
    set u = CreateUnit( p, 'nhrr', -5554.9, -5350.4, 287.391 )
    set u = CreateUnit( p, 'nvdw', 3586.7, -2606.3, 140.201 )
    set u = CreateUnit( p, 'nvdw', 3135.7, -3006.4, 354.847 )
    set u = CreateUnit( p, 'nvdw', 3195.7, -2564.2, 139.377 )
    set u = CreateUnit( p, 'nvdg', 6425.8, -1781.9, 151.111 )
    set u = CreateUnit( p, 'nvdl', 6600.2, -1783.9, 32.674 )
    set u = CreateUnit( p, 'nvdl', 6315.7, -1559.4, 282.434 )
    set u = CreateUnit( p, 'nvdw', 4870.6, 7396.7, 266.899 )
    set u = CreateUnit( p, 'nvdw', 6251.4, 6004.1, 191.827 )
    set u = CreateUnit( p, 'nepl', 5075.4, -4900.4, 253.298 )
    set u = CreateUnit( p, 'nenp', 4805.7, -5063.8, 302.595 )
    set u = CreateUnit( p, 'nmmu', 4433.4, -7999.2, 193.040 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    call TriggerAddAction( t, function Unit000345_DropItems )
    set u = CreateUnit( p, 'nfel', 296.9, 5835.1, 279.050 )
    set u = CreateUnit( p, 'nfel', -35.7, 6471.8, 168.371 )
    set u = CreateUnit( p, 'owyv', 1408.1, 3236.8, 68.161 )
    set u = CreateUnit( p, 'owyv', 990.3, 3140.7, 141.387 )
    set u = CreateUnit( p, 'nahy', 29.2, 10057.2, 54.980 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    call TriggerAddAction( t, function Unit000352_DropItems )
    set u = CreateUnit( p, 'hmtm', 1603.2, 8979.5, 68.469 )
    set u = CreateUnit( p, 'hmtm', 2130.6, 9774.7, 68.469 )
    set u = CreateUnit( p, 'hmtm', 1526.6, 9424.4, 68.469 )
    set u = CreateUnit( p, 'nvdw', 5439.4, -3693.5, 277.934 )
    set u = CreateUnit( p, 'nvdw', 5825.6, -3728.5, 239.631 )
    set u = CreateUnit( p, 'nvdw', 6785.3, -3018.9, 239.631 )
    set u = CreateUnit( p, 'nvdw', 6797.0, -2611.0, 239.631 )
    set u = CreateUnit( p, 'nvdw', 4760.3, -2482.2, 239.631 )
    set u = CreateUnit( p, 'nvdg', 6939.7, -2861.1, 151.111 )
    set u = CreateUnit( p, 'nerw', 3461.3, -2836.4, 316.214 )
    set u = CreateUnit( p, 'nenp', 4810.9, -4791.0, 302.595 )
    set u = CreateUnit( p, 'ncen', -1747.3, -3430.9, 223.666 )
    set u = CreateUnit( p, 'ncnk', -781.3, -7915.0, 131.460 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    call TriggerAddAction( t, function Unit000365_DropItems )
    set u = CreateUnit( p, 'ncks', -575.4, -8188.3, 85.250 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    call TriggerAddAction( t, function Unit000366_DropItems )
    set u = CreateUnit( p, 'ncks', -1324.4, -7862.8, 87.610 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    call TriggerAddAction( t, function Unit000246_DropItems )
    set u = CreateUnit( p, 'ncim', 307.9, -8019.5, 133.290 )
    set u = CreateUnit( p, 'nmgd', -969.1, 11096.5, 309.910 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
    call TriggerAddAction( t, function Unit000299_DropItems )
    set u = CreateUnit( p, 'nsqa', 3219.6, 6728.1, 306.210 )
    set t = CreateTrigger(  )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_DEATH )
    call TriggerRegisterUnitEvent( t, u, EVENT_UNIT_CHANGE_OWNER )
...
function CreateNeutralPassiveBuildings takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'nef1', 6048.0, -12768.0, 270.000 )
    set u = CreateUnit( p, 'ngwr', 5088.0, -12640.0, 270.000 )
    ...
    set u = CreateUnit( p, 'nwgt', 7104.0, -10176.0, 270.000 )
    call WaygateSetDestination( u, GetRectCenterX(gg_rct_portTarg), GetRectCenterY(gg_rct_portTarg) )
...
function CreateNeutralPassive takes nothing returns nothing
    ...
    call SetUnitState( gg_unit_edcm_0004, UNIT_STATE_MANA, 200 )
    ...
    call SetUnitState( gg_unit_edcm_0044, UNIT_STATE_MANA, 200 )
    ...
    call SetUnitState( gg_unit_edcm_0047, UNIT_STATE_MANA, 200 )
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_Gebiet_001 = Rect( 4896.0, -12928.0, 5088.0, -12672.0 )
    set gg_rct_Gebiet_002 = Rect( 6048.0, -12800.0, 6208.0, -12608.0 )
    ...
    set gg_rct_way6 = Rect( -1536.0, -8672.0, -608.0, -7808.0 )
    set gg_rct_way7 = Rect( 5792.0, -7776.0, 6464.0, -7136.0 )
    set gg_rct_way8 = Rect( 6496.0, -2272.0, 6752.0, -1984.0 )
    ...
    set gg_rct_way8b = Rect( 5568.0, -1856.0, 5920.0, -1504.0 )
    set gg_rct_portTarg = Rect( 4128.0, -3776.0, 4352.0, -3584.0 )
    set gg_rct_way6b = Rect( 352.0, -6432.0, 1280.0, -6016.0 )
endfunction
...
function CreateCameras takes nothing returns nothing
    ...
    call CameraSetupSetField( gg_cam_village, CAMERA_FIELD_TARGET_DISTANCE, 2415.8, 0.0 )
    ...
    call CameraSetupSetDestPosition( gg_cam_village, 5620.8, -12296.9, 0.0 )
...
// Trigger: init
//===========================================================================
function Trig_init_Func002Func003Func001C takes nothing returns boolean
...
function Trig_init_Func002Func003A takes nothing returns nothing
    if ( Trig_init_Func002Func003Func001C() ) then
        set udg_heroes[GetForLoopIndexA()] = GetEnumUnit()
        call UnitAddItemByIdSwapped( 'stel', GetEnumUnit() )
    else
    endif
endfunction

function Trig_init_Func003Func001C takes nothing returns boolean
...
function Trig_init_Func003A takes nothing returns nothing
    if ( Trig_init_Func003Func001C() ) then
        call TriggerRegisterDeathEvent( gg_trg_kegExplo, GetEnumDestructable() )
    else
    endif
endfunction

function Trig_init_Actions takes nothing returns nothing
    call CreateTextTagLocBJ( "TRIGSTR_152", GetDestructableLoc(gg_dest_DTlv_1712), 0, 10, 100, 0.00, 0.00, 0 )
    set bj_forLoopAIndex = 1
    set bj_forLoopAIndexEnd = 12
    loop
        exitwhen bj_forLoopAIndex > bj_forLoopAIndexEnd
        call SetPlayerAllianceStateBJ( ConvertedPlayer(GetForLoopIndexA()), Player(PLAYER_NEUTRAL_PASSIVE), bj_ALLIANCE_ALLIED_VISION )
        call SetPlayerAllianceStateBJ( Player(PLAYER_NEUTRAL_PASSIVE), ConvertedPlayer(GetForLoopIndexA()), bj_ALLIANCE_ALLIED_VISION )
        call ForGroupBJ( GetUnitsOfPlayerAll(ConvertedPlayer(GetForLoopIndexA())), function Trig_init_Func002Func003A )
        set bj_forLoopAIndex = bj_forLoopAIndex + 1
    endloop
    call EnumDestructablesInRectAll( GetPlayableMapRect(), function Trig_init_Func003A )
endfunction
...
//===========================================================================
// Trigger: difficultyUp
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
function Trig_difficultyUp_Actions takes nothing returns nothing
    call DisplayTextToForce( GetPlayersAll(), "TRIGSTR_149" )
    call SetPlayerTechResearchedSwap( 'R003', 1, Player(PLAYER_NEUTRAL_PASSIVE) )
    call UnitAddAbility(bears[1], 'A00H')
    call UnitAddAbility(bears[2], 'A00H')
    call UnitAddAbility(bears[3], 'A00H')
    call UnitAddAbility(vans[1], 'A00H')
    call UnitAddAbility(vans[2], 'A00H')
    call UnitAddAbility(vans[3], 'A00H')
    call UnitAddAbility(kael, 'A00H')
endfunction

//===========================================================================
function InitTrig_difficultyUp takes nothing returns nothing
    set gg_trg_difficultyUp = CreateTrigger(  )
    call TriggerRegisterDeathEvent( gg_trg_difficultyUp, gg_dest_DTlv_1712 )
    call TriggerAddAction( gg_trg_difficultyUp, function Trig_difficultyUp_Actions )
endfunction
...
function CineWait takes real time returns nothing
    if (skipIntro) then
        return
    endif
...
function goTor takes nothing returns nothing
    ...
    call IncUnitAbilityLevel(tor, 'Atdg')
endfunction
...
function part2 takes nothing returns nothing
    ...
    call speakWait(kael, "Our beautiful village has been consumed by nature...|nAnd even the life-spending river dried up.", 7)
    call speakWait(kael, "Now we have no choice but to trek through the deserts.|nTo find the rumored idyll our ancestors spoke of.", 7)
endfunction
...
//TESH.alwaysfold=0
globals
    group wispG=CreateGroup()
endglobals

function selWisp_enum takes nothing returns nothing
...
function Trig_kaelSel_Actions takes nothing returns nothing
    if (GetTriggerUnit() != kael) then
        return
    endif
    
    call GroupEnumUnitsOfPlayer(wispG, GetTriggerPlayer(), null)
    
    call ForGroup(wispG, function selWisp_enum)
endfunction

//===========================================================================
function InitTrig_kaelSel takes nothing returns nothing
    local integer i = 11
    set gg_trg_kaelSel = CreateTrigger(  )
    
    call TriggerAddAction( gg_trg_kaelSel, function Trig_kaelSel_Actions )
    
    loop
        exitwhen (i<0)
        call TriggerRegisterPlayerSelectionEventBJ( gg_trg_kaelSel, Player(i), true )
        set i=i-1
    endloop
endfunction
...
// Trigger: invUp
//===========================================================================
function Trig_invUp_Conditions takes nothing returns boolean
...
function Trig_invUp_Actions takes nothing returns nothing
    call IncUnitAbilityLevelSwapped( 'AInv', udg_heroes[GetConvertedPlayerId(GetTriggerPlayer())] )
endfunction

//===========================================================================
function InitTrig_invUp takes nothing returns nothing
    set gg_trg_invUp = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_invUp, EVENT_PLAYER_UNIT_RESEARCH_FINISH )
    call TriggerAddCondition( gg_trg_invUp, Condition( function Trig_invUp_Conditions ) )
    call TriggerAddAction( gg_trg_invUp, function Trig_invUp_Actions )
endfunction

//===========================================================================
// Trigger: reincarnationUp
//===========================================================================
function Trig_reincarnationUp_Conditions takes nothing returns boolean
...
function Trig_reincarnationUp_Actions takes nothing returns nothing
    call IncUnitAbilityLevelSwapped( 'A00D', udg_heroes[GetConvertedPlayerId(GetTriggerPlayer())] )
endfunction

//===========================================================================
function InitTrig_reincarnationUp takes nothing returns nothing
    set gg_trg_reincarnationUp = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_reincarnationUp, EVENT_PLAYER_UNIT_RESEARCH_FINISH )
    call TriggerAddCondition( gg_trg_reincarnationUp, Condition( function Trig_reincarnationUp_Conditions ) )
    call TriggerAddAction( gg_trg_reincarnationUp, function Trig_reincarnationUp_Actions )
endfunction
...
function kaelDeath takes nothing returns nothing
    ...
    call BJDebugMsg("Kael could not reach the ancestors, only in death were they to meet up...")

    call Cine(100, 100, 100, 10., "ReplaceableTextures\\CameraMasks\\Black_mask.blp", 100, 0)
    
    call TriggerSleepAction(5)
    
    call PauseGame(true)
    call BJDebugMsg("Thanks for playing")
...
function death takes nothing returns nothing
    ...
    if (bearsC == 0) then
        call BJDebugMsg("the last juggernaut bites the dust, now Kael is vulnerable, protect him at all costs!")
        
        call UnitRemoveAbility(kael, 'Avul')
        call UnitRemoveAbility(kael, 'A00J')
    elseif (bearsC == 1) then
        call BJDebugMsg("only one juggernaut remaining!")
    else
        call BJDebugMsg("oh noez, a juggernaut died :(")
    endif
...
function setup takes nothing returns nothing
    ...
    call addWay(gg_rct_way6b)
    call addWay(gg_rct_way7)
    call addWay(gg_rct_way8)
    call addWay(gg_rct_way8b)
    ...
    set kaelDeathTrigger=CreateTrigger()
    
    call TriggerAddAction(kaelDeathTrigger, function kaelDeath)
    call TriggerRegisterUnitEvent(kaelDeathTrigger, kael, EVENT_UNIT_DEATH)
    
    call TimerStart(CreateTimer(), 0.01, true, function updateBolts)
    
    call UnitAddAbility(kael, 'Aeth')
    call UnitAddAbility(kael, 'A00J')
...
function end takes nothing returns nothing
    ...
    call SetUnitInvulnerable(bears[1], true)
    call SetUnitInvulnerable(bears[2], true)
    call SetUnitInvulnerable(bears[3], true)
    call SetUnitInvulnerable(kael, true)
...
// Trigger: kegExplo
//===========================================================================
function Trig_kegExplo_Func001A takes nothing returns nothing
    call UnitDamageTargetBJ( GetEnumUnit(), GetEnumUnit(), 200.00, ATTACK_TYPE_SIEGE, DAMAGE_TYPE_DEMOLITION )
endfunction

function Trig_kegExplo_Actions takes nothing returns nothing
    call ForGroupBJ( GetUnitsInRangeOfLocAll(200.00, GetDestructableLoc(GetDyingDestructable())), function Trig_kegExplo_Func001A )
endfunction

//===========================================================================
function InitTrig_kegExplo takes nothing returns nothing
    set gg_trg_kegExplo = CreateTrigger(  )
    call TriggerAddAction( gg_trg_kegExplo, function Trig_kegExplo_Actions )
endfunction

//===========================================================================
function InitCustomTriggers takes nothing returns nothing
    call InitTrig_init(  )
    call InitTrig_difficultyUp(  )
    call InitTrig_village(  )
    call InitTrig_kaelSel(  )
    call InitTrig_invUp(  )
    call InitTrig_reincarnationUp(  )
    call InitTrig_way(  )
    call InitTrig_pigs(  )
